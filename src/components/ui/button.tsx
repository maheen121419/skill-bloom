  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-mono uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground font-pixel text-xs border-2 border-primary shadow-[4px_4px_0_0_hsl(var(--primary)),_-1px_-1px_0_0_hsl(var(--primary)/0.3)] hover:scale-105 transition-transform",
        accent: "bg-accent text-accent-foreground font-pixel text-xs border-2 border-accent shadow-[4px_4px_0_0_hsl(var(--accent)),_-1px_-1px_0_0_hsl(var(--accent)/0.3)] hover:scale-105 transition-transform",
        locked: "bg-muted text-muted-foreground border-2 border-muted cursor-not-allowed opacity-60",
      },
      size: {
